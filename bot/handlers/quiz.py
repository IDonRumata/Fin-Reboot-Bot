...
QUESTIONS = {
    "q1": {
        "text": (
            "🛋️ <b>Вопрос 1 из 6</b>\n\n"
            "Честно: твои сбережения сейчас работают "
            "или просто лежат и стареют?"
        ),
        "options": [
            ("A", "Лежат. Зато надёжно"),
            ("B", "Лежат на вкладе. 9% годовых — звучит солидно"),
            ("C", "Частично работают, но я не очень понимаю как"),
            ("D", "Работают. Я слежу за этим"),
        ],
    },
    "q2": {
        "text": (
            "📰 <b>Вопрос 2 из 6</b>\n\n"
            "Ты видишь заголовок «Bitcoin вырос на 40% за месяц». "
            "Твоя реакция?"
        ),
        "options": [
            ("A", "Опять эти крипто-авантюристы. Не для меня"),
            ("B", "Жалею, что не купил(а) раньше. Теперь поздно"),
            ("C", "Интересно, но страшно. Читаю, но не действую"),
            ("D", "Смотрю, какую часть портфеля стоит перебалансировать"),
        ],
    },
    "q3": {
        "text": (
            "💬 <b>Вопрос 3 из 6</b>\n\n"
            "Друг говорит: «Я купил ETF на S&P 500». Ты думаешь:"
        ),
        "options": [
            ("A", "Что такое ETF?"),
            ("B", "Слышал(а), но не уверен(а) что это безопасно"),
            ("C", "Нормальная стратегия, сам(а) думаю попробовать"),
            ("D", "Давно держу. Скучно, но работает"),
        ],
    },
    "q4": {
        "text": (
            "🧮 <b>Вопрос 4 из 6</b>\n\n"
            "Ты знаешь, сколько потеряли твои деньги на вкладе в BYN "
            "за последние 3 года из-за инфляции?"
        ),
        "options": [
            ("A", "Нет. И не хочу знать — испорчу настроение"),
            ("B", "Примерно представляю, но что поделаешь"),
            ("C", "Знаю. Поэтому часть уже перевёл(а) в валюту"),
            ("D", "Знаю точно. Поэтому давно не держу в BYN"),
        ],
    },
    "q5": {
        "text": (
            "⌛ <b>Вопрос 5 из 6</b>\n\n"
            "Сколько часов в месяц ты готов(а) тратить "
            "на управление инвестициями?"
        ),
        "options": [
            ("A", "Ноль. Я хочу чтобы само работало"),
            ("B", "1–2 часа, не больше"),
            ("C", "3–5 часов, если это реально даёт результат"),
    ...
    "q6": {
        ...
        "options": [
            ("A", "Наконец-то разобраться с этими инвестициями"),
            ("B", "Иметь финансовую подушку и спать спокойно"),
            ("C", "Получать пассивный доход и меньше работать"),
            ("D", "Уже жить на доходы от капитала"),
        ],
    },
}
...
RESULT_TEXTS = {
    "A": (
        ...
        "инфляция тихо их съедает. За 5 лет вклад в BYN теряет "
        ...
        "▸ Конкретные инструменты для Беларуси\n\n"
        "Даже $10 в месяц — уже старт. "
    ...
    "B": (
        ...
        "💡 <b>Что тебе даст курс:</b>\n"
        "▸ Пошаговый план: от баланса до первого ETF\n"
        "▸ Открытие крипто-кошелька и брокерского счёта\n"
        "▸ Стратегия DCA — покупай регулярно и не парься\n\n"
        "Через 5 дней у тебя будет работающая система, "
        "а не просто желание «когда-нибудь начать» 🎯"
    ),
    "C": (
        "📊 <b>{name}, ты — Инвестор без системы</b>\n\n"
        "Ты уже разбираешься в теме — возможно, даже покупал(а) "
        "акции или крипту. Но когда спрашиваешь себя «а что дальше?» — "
        "чёткого плана нет.\n\n"
        "Хаотичные инвестиции без стратегии — это не инвестирование, "
        "а лотерея. У тебя есть навыки, нет структуры.\n\n"
        "💡 <b>Что тебе даст курс:</b>\n"
        "▸ Как собрать диверсифицированный портфель\n"
        "▸ Распределение между крипто, акциями и недвижимостью\n"
