...
FOLLOWUP_MESSAGES = {
    1: {
        ...
        "text": (
            ...
            "📋 <b>Чек-лист «Подготовься к первой инвестиции»</b>\n\n"
            "7 вопросов, которые помогут понять: готов(а) ли ты, "
            "сколько откладывать, на какой срок и зачем вообще. "
            "Занимает 5 минут — и ты уже на шаг впереди.\n\n"
